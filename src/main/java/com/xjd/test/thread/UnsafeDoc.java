...
public final class UnsafeDoc {
	...
	private static final UnsafeDoc theUnsafe = new UnsafeDoc();
	 ...
	 *
	 * @exception SecurityException if a security manager exists and its <code>checkPropertiesAccess</code> method
	 *                doesn't allow access to the system properties.
	 */
	public static UnsafeDoc getUnsafe() {
