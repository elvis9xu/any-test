 ...
 */
public class AlipayAppMobileWebTest extends AlipayPassword {
	...
	public static void wapPay(AlipayClient alipayClient) {
		...
		request.setReturnUrl("http://test-vip.wozai4u.com/");
...
//		request.setNotifyUrl("http://vip.xxx.vvaccess.com");
		...
		request.setBizContent("{" +
				...
				"\"timeout_express\":\"30m\"" +
				"}");
		request.putOtherTextParam("app_auth_token", "201805BBdf45ff5134964218acf0b82ded9cfC79");
