...
public class DESHelper {
    ...
    public String decryptStr(String strMi) {
        ...
        try {
            ...
            throw new RuntimeException("Error on decryptStr. Cause: " + e);
        } finally {
            byteMing = null;
            byteMi = null;
        }
    ...
    private byte[] decryptByte(byte[] byteD) {
        ...
        try {
            ...
            throw new RuntimeException("Error on decryptByte. Cause: " + e);
        } finally {
            cipher = null;
        }
        return byteFina;
    ...
    public static void main(String[] args) throws Exception {
        DESHelper des = new DESHelper("123456789");
        String str1 = "zsty:81290091238509552796:oz45Tt1eHadsai67QGhrohomsSN0::艾德";
        // DES 加密字符串
